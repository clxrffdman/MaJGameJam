...
public class PlayerAnim : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (animCheck == true && !levelControl.paused)
        {
            ...
            if (Input.GetKey("w") || Input.GetKey("a") || Input.GetKey("s") || Input.GetKey("d") || Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.UpArrow))
            {
                if(run == false)
                {
                    GameObject.Find("Player").transform.GetChild(0).GetComponent<WeaponBobber>().StartBob(2);
                }
            ...
            else
            {
                if (run == true)
                {
                    GameObject.Find("Player").transform.GetChild(0).GetComponent<WeaponBobber>().StartBob(1);
                }
    ...
    void CheckSprint()
    {
        ...
        if (run && !mUp && mLeft && (Input.GetKey("a") || Input.GetKey(KeyCode.LeftArrow)))
        {
            anim.SetBool("s", false);
            anim.SetBool("a", true);
        }
        if (run && !mUp && !mLeft && (Input.GetKey("d") || Input.GetKey(KeyCode.RightArrow)))
        {
            anim.SetBool("s", false);
            anim.SetBool("d", true);
        }
        if ((Input.GetKeyUp("d") && Input.GetKey("s")) || (Input.GetKeyUp(KeyCode.RightArrow) && Input.GetKey(KeyCode.DownArrow)))
        {
            anim.SetBool("s", true);
        }
