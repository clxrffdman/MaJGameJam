    ...
    */
    ...
    void MissNoise()
    {
        if (!madeNoise)
        {
            ...
            sound.GetComponent<SoundSample>().SpawnSound(swordSounds[Random.Range(2, 4)], 0f, 0.4f);
            madeNoise = true;
        }
    }
    ...
    void OnTriggerEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.tag == "Enemy")
        {
            ...
            {
                var sound = Instantiate(soundSpawn, transform.position, Quaternion.identity);
                sound.GetComponent<SoundSample>().SpawnSound(swordSounds[Random.Range(0, 2)], 0f, 0.15f);
                madeNoise = true;
    ...
    void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (other.gameObject.tag == "Enemy")
        {
            ...
            {
                var sound = Instantiate(soundSpawn, transform.position, Quaternion.identity);
                sound.GetComponent<SoundSample>().SpawnSound(swordSounds[Random.Range(0, 2)], 0f, 0.4f);
                madeNoise = true;
